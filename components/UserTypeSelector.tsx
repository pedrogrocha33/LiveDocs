  ...
  return (
    <Select value={userType} onValueChange={(type: UserType) => accessChangeHandler(type)}>
      ...
      <SelectContent className="border-none bg-dark-200">
        <SelectItem value="viewer" className="shad-select-item">pode visualizar</SelectItem>
        <SelectItem value="editor" className="shad-select-item">pode editart</SelectItem>
      </SelectContent>
    </Select>
  )
}
